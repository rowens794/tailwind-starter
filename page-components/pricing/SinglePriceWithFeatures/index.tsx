        ...
        <div className="pb-16 xl:flex xl:items-center xl:justify-between">
          <div>
            <h1 className="text-4xl font-extrabold sm:text-5xl sm:tracking-tight">
              ...
              <span className={`text-${color}-600`}>$99 a month</span>
            </h1>
          ...
          <a
            href="#"
            className={`inline-flex items-center justify-center w-full px-5 py-3 mt-8 text-base font-medium text-white bg-${color}-600 border border-transparent rounded-md hover:bg-${color}-700 sm:mt-10 sm:w-auto xl:mt-0`}
          >
            Get started today
          </a>
        </div>
