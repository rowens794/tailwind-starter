    ...
    <div className="min-h-screen px-4 py-16 bg-white sm:px-6 sm:py-24 md:grid md:place-items-center lg:px-8">
      <div className="mx-auto max-w-max">
        <main className="sm:flex">
          <p
            className={`text-4xl font-extrabold text-${color}-600 sm:text-5xl`}
          >
            404
          </p>
          <div className="sm:ml-6">
            ...
            <div className="flex mt-10 space-x-3 sm:border-l sm:border-transparent sm:pl-6">
              ...
              <a
                href="#"
                className={`inline-flex items-center px-4 py-2 text-sm font-medium text-${color}-700 bg-${color}-100 border border-transparent rounded-md hover:bg-${color}-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-${color}-500`}
              >
                Contact support
              </a>
            </div>
